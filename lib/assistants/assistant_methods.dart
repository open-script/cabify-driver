...
class AssistantMethods
{
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    {
      double resultFareAmount = (totalFareAmount.truncate()) * 0.4 * 76.43;
      return resultFareAmount.round() * 1.0;
    }
    else if(driverVehicleType == "uber-go")
    {
      return (totalFareAmount.truncate().toDouble()  * 0.6 * 76.43).round() * 1.0;
    }
    else if(driverVehicleType == "uber-x")
    {
      double resultFareAmount = (totalFareAmount.truncate()) *  0.85 * 76.43;
      return resultFareAmount.round() * 1.0;
    }
    else
    {
      return totalFareAmount.truncate().toDouble().round() * 1.0;
    }
  }
